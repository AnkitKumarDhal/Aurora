          ...
          <div className="flex h-[75vh] flex-col items-center justify-center">
            ...
            <div className="grid w-full max-w-4xl grid-cols-1 gap-8 px-4 md:grid-cols-2">
              <Button
                type="button"
                variant="outline"
                className="flex h-64 w-full flex-col items-center justify-center gap-6 rounded-2xl border-2 border-border bg-surface text-text-primary transition-all hover:border-primary hover:bg-primary-tint"
                onClick={() => {
                  registerActivity();
