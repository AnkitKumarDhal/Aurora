  ...
  return (
    ...
    >
      ...
      <div className="flex gap-6">
        <Button
          onClick={onDecline}
          className="px-10 py-6 text-xl rounded-xl border-2 border-[var(--color-danger)] text-[var(--color-danger)] hover:bg-[var(--color-danger)] hover:text-white transition-all min-w-[200px] bg-transparent"
        >
