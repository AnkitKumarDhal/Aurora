...
@router.get(
    "",
    response_model=dict[str, InterviewStateResponse],
)
...
@router.post(
    "/turns",
    response_model=dict[str, InterviewTurnResponse],
...
@router.post(
    "/finalize",
    response_model=dict[str, InterviewFinalizeResponse],
)
async def finalize_interview(
    ...
    return {
        "data": InterviewFinalizeResponse(
