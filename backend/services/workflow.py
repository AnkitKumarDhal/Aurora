...
class WorkflowService:
    ...
    async def queue_session(self, entry: QueueEntry) -> QueueEntry:
        ...
        await self.session_service.transition_session(entry.session_id, SessionStatus.QUEUED,)
        return queued_entry
    ...
    async def assign_patient(self, session_id: str, queue_entry_id: str) -> DoctorAssignment | None:
        ...
        if assignment is None:
            return None
        await self.queue_service.update_entry(queue_entry_id, {"doctor_id": assignment.doctor_id})
    ...
    async def complete_consultation(self, session_id: str, queue_entry_id: str, doctor_id: str | None = None) -> QueueEntry:
        ...
        await self.session_service.transition_session(session_id, SessionStatus.COMPLETED)
