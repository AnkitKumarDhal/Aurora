...
from backend.services.promotion_workflow import PromotionWorkflowService
from backend.services.queue import QueueService
from backend.services.reassignment import ReassignmentService
...
def get_workflow_service() -> WorkflowService:
    ...
    return WorkflowService(
        ...
        promotion_workflow=get_promotion_workflow_service(),
    )
...
def get_interview_controller() -> InterviewController:
    return InterviewController(
        session_service=ClinicalSessionService(ClinicalSessionRepository()),
        conversation_service=get_conversation_service(),
        signal_service=ClinicalSignalService(ClinicalSignalRepository()),
        summary_service=ClinicalSummaryService(ClinicalSummaryRepository()),
        triage_service=TriageService(
            repository=TriageRepository(),
            signal_repository=ClinicalSignalRepository(),
