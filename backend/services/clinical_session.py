...
class ClinicalSessionService:
    ...
    async def transition_session(self, session_id: str, new_status: SessionStatus,) -> ClinicalSession | None:
        ...
        await self.repository.update_session(session_id, document.to_mongo())
