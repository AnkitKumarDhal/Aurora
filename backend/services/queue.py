...
class QueueService:
    ...
    async def get_department_queue(
        ...
        documents = await self.repository.get_department_queue(
            department_id,
        )
    ...
    async def get_department_entries(
        ...
        documents = await self.repository.get_department_entries(
            department_id,
            start_at,
            end_at,
        )
    ...
    async def get_entry(
        ...
        document = await self.repository.get_entry(
            queue_entry_id,
        )
    ...
    async def get_session_entry(
        ...
        document = await self.repository.get_session_entry(
            session_id,
        )
    ...
    async def update_entry(
        ...
        document = await self.repository.update_entry(
            queue_entry_id,
            updates,
        )
        ...
        entry = self._to_domain(document)
